...
local name="Trix arsenal - Undetected - "..identifyexecutor()..""
...
CombatTabMainSection:Toggle("Kill All (fixing)",function(state)
    if state then
...
W:Button("Copy Discord Link To Clip Board",function()
    setclipboard("https://discord.gg/doon")
end)
W:Button("Click to copy TOS",function()

setclipboard("You argee that your username your country and your executer will be publicly logged and you agree that this script is not reponsable for you being banned from arsenal and also you agree that you will not use your main account when exploiting")
end)
